...
) ENGINE = InnoDB AUTO_INCREMENT = 7 COMMENT = '系统权限';
...
INSERT INTO `t_sys_auth` VALUES (7, '系统任务调度权限', 'sys:job');
...
CREATE TABLE `t_sys_job`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 COMMENT = '定时任务';
...
CREATE TABLE `t_sys_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 COMMENT = '系统角色';
...
CREATE TABLE `t_sys_role_auth`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 COMMENT = '角色权限关系';
...
CREATE TABLE `t_sys_user_role`  (
  ...
  `role_id` bigint(20) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 COMMENT = '用户角色关系';
